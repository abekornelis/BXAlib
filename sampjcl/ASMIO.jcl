//ASMIO    JOB (7355,710,&SYSUID),'Assemble Source',NOTIFY=&SYSUID,     00010000
...
//ASMIO    EXEC BXAASM,MEMB=BXAIO,PROJ=GOODIES,LVL=PROD                 00060000
//*                                                                     00070000
//* Compile ok? Invoke linkage editor                                   00080000
//         IF   (ASMIO.ASMPROD.RC LT 4) THEN                            00090000
//LNKIO    EXEC BXALKED,MEMB=BXAIO,PROJ=GOODIES,LVL=PROD                00100000
//         ENDIF                                                        00110000
