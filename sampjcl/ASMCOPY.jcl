//ASMCOPY  JOB (7355,710,&SYSUID),'Assemble Source',NOTIFY=&SYSUID,     00010000
...
//ASMCOPY  EXEC BXAASM,MEMB=BXACOPY,PROJ=GOODIES,LVL=PROD               00060000
//*                                                                     00070000
//* Compile ok? Invoke linkage editor                                   00080000
//         IF   (ASMCOPY.ASMPROD.RC LT 4) THEN                          00090000
//LNKCOPY  EXEC BXALKED,MEMB=BXACOPY,PROJ=GOODIES,LVL=PROD              00100000
//         ENDIF                                                        00110000
