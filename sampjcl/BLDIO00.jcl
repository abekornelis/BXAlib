//BLDIO00  JOB (7355,710,&SYSUID),'Build Loadmod',NOTIFY=&SYSUID,       00010000
...
//             PARM.ASMPROD=(OBJECT,NODECK,TERM,'SYSPARM(NODEBUG,OPT)') 00070000
//LKDIO00  EXEC BXALKED,MEMB=BXAIO00,PROJ=GOODIES,LVL=PROD              00080000
