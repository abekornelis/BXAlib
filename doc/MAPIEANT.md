...
Supported values:
- NTCRPL - Named Token CReate Parameter List
- NTDLPL - Named Token DeLete Parameter List
- NTRTPL - Named Token ReTrieve Parameter List
...
The [MAPIEANT macro](../bxamac/MAPIEANT.mac) is in the BXAmac folder.
