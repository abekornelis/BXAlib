...
This macro maps the IOS Dynamic Device Reconfiguration COMmunication table
...
Supported values:
- DDRCOM - IOS Dynamic Device Reconfiguration COMmunication area
...
The [MAPDDRCO macro](../bxamac/MAPDDRCO.mac) is in the BXAmac folder.
