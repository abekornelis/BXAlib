...
Supported values:
- FRRS     - Function Recovery Routine Stack
- FRRSENTR - FRR ENTRy
- FRRSXENT - FRR ENTry eXtension
- FRRSXSTK - FRR STacK eXtension
...
The [MAPFRRS macro](../bxamac/MAPFRRS.mac) is in the BXAmac folder.
