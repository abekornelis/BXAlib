...
Supported values:
- CAMLOC    - CAMlst LOCate results
- CAMLOCVOL - CAMlst LOCate VOLume entry
- CAMLST    - CAMLST parameter list
...
The [MAPCAM macro](../bxamac/MAPCAM.mac) is in the BXAmac folder.
